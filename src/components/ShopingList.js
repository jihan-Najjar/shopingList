...
const ShopingList = ({ shopingList, setShopingList }) => {
  ...
  return (
    ...
    <div className="d-flex iiiii">
    {shopingList.length > 0 ? <button onClick={handleConfirme}>Confirmation</button>:"" }

    </div>
    </>
    
    ):<Checkout setConfirme={setConfirme}/>}
